        ...
        static void Main(string[] args)
        {
            ...
            switch (algorith.Key)
            {
                ...
                case ConsoleKey.D:
                    ...
                    if (bt.Search(20, bt.GetRoot()) != null)
                        Console.WriteLine("The index of 20 element: " + bt.Search(20, bt.GetRoot()).Index);
                    else 
                        Console.WriteLine("It was not possible to find the 20 element in the dataset.");
                    
                    if (bt.Search(26, bt.GetRoot()) != null)
                        Console.WriteLine("The index of 26 element: " + bt.Search(26, bt.GetRoot()).Index);
                    else
                        Console.WriteLine("It was not possible to find the 26 element in the dataset.\n");
